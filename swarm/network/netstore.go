...
// the fetchers cache
func (n *NetStore) Put(ctx context.Context, mode chunk.ModePut, chunk storage.Chunk) error {
	n.putMu.Lock()
	...
	err := n.Store.Put(ctx, mode, chunk)
	if err != nil {
		return err
	}
...
func (n *NetStore) Get(ctx context.Context, mode chunk.ModeGet, req *Request) (storage.Chunk, error) {
...
func (n *NetStore) Has(ctx context.Context, ref storage.Address) (bool, error) {
