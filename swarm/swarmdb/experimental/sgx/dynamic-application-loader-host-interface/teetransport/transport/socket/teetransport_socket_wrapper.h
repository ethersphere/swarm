...
/**
*    @file        TEETransportSocketWrapper.h
*    @brief       Defines internal interface for socket library.
*    @author      Artum Tchachkin
*    @date        August 2014
*/
#ifndef _TEE_TRANSPORT_SOCKET_WRAPPER_H_
#define _TEE_TRANSPORT_SOCKET_WRAPPER_H_
...
extern "C" {
   ...
   TEE_COMM_STATUS SOCK_Recv(IN TEE_TRANSPORT_INTERFACE_PTR pInterface, IN TEE_TRANSPORT_HANDLE handle, OUT uint8_t* buffer, IO uint32_t* length);

#ifdef __cplusplus
};
#endif

#endif //_TEE_TRANSPORT_SOCKET_WRAPPER_H_