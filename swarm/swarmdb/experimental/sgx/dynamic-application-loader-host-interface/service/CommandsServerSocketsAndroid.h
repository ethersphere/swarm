...
********************************************************************************
**
**    @file CommandsServerSocketsAndroid.h
**
**    @brief  Contains android sockets implementation for commands server
**
...
namespace intel_dal
{
	...
	class CommandsServerSocketsAndroid : public ICommandsServer
	{
	private:
		SOCKET _socket;
	...
	public:
	   CommandsServerSocketsAndroid(ICommandDispatcher* dispatcher, uint8_t maxClientNum);
	   ~CommandsServerSocketsAndroid();
	   bool open();
	   bool close();
