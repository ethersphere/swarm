...
type NetworkHook struct {
	NetworkControl
	NodesController *ResourceController
	UpdateHandler   *ResourceHandler
}
...
func NewNetworkController(net NetworkControl, nodesController *ResourceController, updateHandler *ResourceHandler) Controller {
	journal := NewJournal()
