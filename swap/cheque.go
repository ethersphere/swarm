...
func (cheque *Cheque) verifyChequeAgainstLast(lastCheque *Cheque, expectedAmount *boundedint.Uint256) (*boundedint.Uint256, error) {
	actualAmount := boundedint.NewUint256().Copy(cheque.CumulativePayout)
